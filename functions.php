...
function gallery_nav_below() {
  if (!(is_single())) { ?>
			...
			<div id="nav-below" class="navigation">
                ...
                <?php wp_pagenavi(); ?>
                <?php } else { ?>  
				<div class="nav-previous"><?php next_posts_link(__('<span class="meta-nav">&laquo;</span> Older products', 'thematic')) ?></div>
				<div class="nav-next"><?php previous_posts_link(__('Newer products <span class="meta-nav">&raquo;</span>', 'thematic')) ?></div>
				<?php } ?>
			</div>	
  ...
  while ( have_posts() ) : the_post() ?>
			...
			?>">
				<div class="entry-content">
                    ...
                    <img class="thumbnail" src="<?php if(get_post_meta($post->ID, 'thumbnail', $single = true)){echo get_post_meta($post->ID, 'thumbnail', $single = true);} else{bloginfo('url'); echo "/wp-content/themes/gallery/images/thumbnail-default.jpg";} ?>" width="125" height="125" alt="<?php echo the_title() ?>" title="Click for more info"/></a>
				</div>
			</div><!-- .post -->
